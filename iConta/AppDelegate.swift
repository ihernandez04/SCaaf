...
class AppDelegate: UIResponder, UIApplicationDelegate, CLLocationManagerDelegate {
    ...
    let APP_ID = "A4D23944-2B2C-1834-FF27-3A8209116C00"
    let SECRET_KEY = "FA487959-E5C0-BDD6-FF68-E8BA78244900"
    let VERSION_NUM = "v1"
    ...
    // MARK: Location Manager funtions
    ...
    //MARK: CLLocationManager Location
